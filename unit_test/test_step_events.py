...
class StepEventPluginTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_plugin_publishes_realtime_tool_start_and_finish(self) -> None:
        ...
        self.assertEqual(self.messages[0].metadata["activity_group_id"], "session-1:turn:4")
        ...
        self.assertEqual(self.messages[1].metadata["activity_group_id"], "session-1:turn:4")
        self.assertEqual(self.messages[1].metadata["activity_sequence"], 2)
    ...
    async def test_orchestration_event_is_published_realtime(self) -> None:
        ...
        self.assertEqual(self.messages[0].metadata["activity_group_id"], "session-3")
    ...
    async def test_append_orchestration_step_event_updates_state_and_publishes(self) -> None:
        ...
        self.assertEqual(self.messages[0].metadata["activity_group_id"], "session-append:turn:3")
        self.assertEqual(self.messages[0].metadata["activity_sequence"], 1)
