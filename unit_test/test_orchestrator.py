...
class OrchestratorTests(unittest.TestCase):
    def test_instruction_mentions_structured_final_response_contract(self) -> None:
        ...
        self.assertIn("SRT/VTT", instruction)
        self.assertIn("Creative media workflow hints", instruction)
        self.assertIn("Do not assume video or media planning skills are globally available", instruction)
        self.assertIn("Only read skills that appear in the Available skills list", instruction)
        self.assertIn("reason directly and prepare the smallest useful plan", instruction)
        self.assertNotIn("creative-brief-to-storyboard", instruction)
        self.assertNotIn("narration-to-visual-prompts", instruction)
        self.assertNotIn("asset-to-script", instruction)
        self.assertNotIn("style-brief-to-prompt", instruction)
        self.assertNotIn("creative-workflow-router", instruction)
        self.assertNotIn("creative-qc", instruction)
        ...
        self.assertIn("product-page skills", instruction)
