...
## 📰 News
 - 2026-05-02：发布 v0.3.0；新增设计生产流、DeepSeek V4 LiteLLM 路由、Seedance 2.0 视频生成、扩展 3D provider，并接入新的 DashScope 图像/视频模型。
 - 2026-05-02：新增 DashScope 媒体路线，支持 Wan 2.7 / HappyHorse 1.0 视频生成，以及 Wan/Qwen/Z-Image 文生图模型。
